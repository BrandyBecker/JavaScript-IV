...
/* <----- OLD CODE FROM JAVASCRIPT-III ON 8.21.2019 ----------------------------------------------------------------------------------------------------->
...
*/
//-------------------------------------------------------------------------------------------------------------------------------------------------------
//<----- NEW CODE FROM JAVASCRIPT-IV ON 8.22.2019 --------------------------------------------------------------------------------------------------------->
class GameObject {
...
class Hero extends Humanoid {
  ...
  attack(who) {
    ...
    let applyDamage = Math.round(Math.random() * (maxhit - minhit) + maxhit);
    let randomWep = this.weapons[
